...
const DEFAULT_PRICING = {
  ...
  mainDescription:
    'Start free and scale as you grow. No setup fees, no hidden costs. Switch plans anytime to match your invoicing needs.',
  ...
  plan3CTAHref: '/signup',
  bottomTitle: 'Need custom invoicing solutions?',
  bottomDescription:
    'We offer enterprise-grade invoicing with custom integrations, dedicated support, and advanced compliance features for large organizations.',
