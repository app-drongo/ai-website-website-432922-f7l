...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of businesses who trust our platform to manage their invoicing. Get started today or speak with our team to learn more.',
  formTitle: 'Start Your Free Trial',
  formDescription: "Tell us about your business and we'll set up your account within minutes.",
  submitButton: 'Get Started Free',
  contactSectionTitle: 'Need Help?',
  method1Title: 'Email Support',
  method1Description: 'Get help from our team',
  method1Contact: 'support@invoiceapp.com',
  method2Title: 'Sales Team',
  method2Description: 'Speak with our experts',
  method2Contact: '+1 (555) 847-2901',
  ...
  office1Address: '101 Market Street, Suite 300',
  office1Timezone: 'PST (UTC-8)',
  office2City: 'Austin',
  office2Address: '500 Congress Ave, Floor 12',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'Toronto',
  office3Address: '200 Bay Street, Suite 2400',
  ...
  supportNote: 'Priority support included with Pro and Enterprise plans',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder:
    'How many invoices do you send monthly? What features are most important to you?',
} as const;
