...
const DEFAULT_CTA = {
  ...
  mainTitleHighlight: 'Invoicing Process?',
  description:
    'Join over 25,000 businesses who have simplified their billing with our powerful invoicing platform. Create professional invoices, track payments, and get paid faster.',
  ...
  feature3Title: '5-Minute Setup',
  feature3Description: 'Import your data and send your first invoice instantly',
} as const;
